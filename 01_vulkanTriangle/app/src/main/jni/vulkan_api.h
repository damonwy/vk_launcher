...
public:
    ...
    explicit ManagedVulkanDevice(const Params &params, android_app* app);
    ~ManagedVulkanDevice();
...
private:
    ...
    void pick_physical_device(ANativeWindow* platformWindow);
    void create_logical_device();
    void create_swap_chain();
    void create_command_pool();
    void create_render_pass();
    void create_frame_buffers(VkRenderPass& renderPass, VkImageView depthView=0);
    ...
    VulkanSwapchainInfo swap_chain_info_;
    VulkanRenderInfo render_info_;
