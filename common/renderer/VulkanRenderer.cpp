...
void VulkanRenderer::CreateVulkanDevice(ANativeWindow* platformWindow,
  ...
  float priorities[] = {1.0f};//checked
  VkDeviceQueueCreateInfo queueCreateInfo{
    .sType = VK_STRUCTURE_TYPE_DEVICE_QUEUE_CREATE_INFO,//checked
    .pNext = nullptr,
    .flags = 0,
          .queueFamilyIndex = queueFamilyIndex,

          .queueCount = 1,//checked
    .pQueuePriorities = priorities,//checked
  };

  VkDeviceCreateInfo deviceCreateInfo{
    .sType = VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO,//checked
    .pNext = nullptr,
    .queueCreateInfoCount = 1,//checked
    .pQueueCreateInfos = &queueCreateInfo,//checked
    .enabledLayerCount = 0,
    .ppEnabledLayerNames = nullptr,
